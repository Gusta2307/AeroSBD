...
def insert_flight_data():
    ...
    (1, 16093, 4, '2021-06-02 06:30', 10, '2021-06-02 07:30', 4366),
    (2, 15503, 14, '2021-06-02 18:00', 11, '2021-06-02 19:00', 231),
    (3, 27334, 5, '2021-06-02 06:00', 9, '2021-06-02 09:00', 3234),
    (4, 93944, 12, '2021-06-02 19:00', 7, '2021-06-02 21:00', 1134),
    (5, 94954, 21, '2021-06-02 22:15', 26, '2021-06-03 1:00', 134),
    (6, 34744, 29, '2021-06-02 5:00', 22, '2021-06-02 10:00', 134),
    (7, 28224, 8, '2021-06-02 18:00', 23, '2021-06-02 21:00', 6432),
    ...
    (2, 1234, 10, '2021-06-02 9:30', 6, '2021-06-02 11:30', 3545),
    (2, 1534, 10, '2020-06-02 9:30', 1, '2021-06-02 11:30', 3545);
    """
    conn = None
    try:
        # connect to the PostgreSQL database
...
def insert_employee_data():
    ...
    ('GDD',                     'MC',                   'Cuba',         716780131, \'\',       'employee_installation',             99, 10, 18),
